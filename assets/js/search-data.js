...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "publications",
          description: "Publications and research outputs in reversed chronological order.",
          section: "Navigation",
          handler: () => {
          ...
          title: "CV",
          description: "Curriculum vitae of Yuhe Qin.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%71%69%6E%79%75%68%65%36%36%36@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
